...
class I2C_LoadRegTest(BaseTestObject):
    """
    ...
    def i2c_initialize(self):
        ...
        self.i2c_controller.uva(2.7, self.i2c_commands.UVA_RESP_NR, self.i2c_commands.UVA_TIMER_16MS)
        ...
        match self.innopro_family:
            case InnoProFamily.Inno5Pro:
                ...
                self.i2c_controller.cv(round(self.vout_V,2))
                
                
                # if self.vout_V > 5:
                #     self.i2c_controller.process_send_i2c_write(0xAE,0x08,1)
                # self.i2c_controller.cv(round(self.vout_V/1.66,2))
                # else:
                #     self.i2c_controller.cv(self.vout_V-1.9)
        ...
        for self.vin_index, self.vin_freq in enumerate(self.vin_list): 
            ...
            for iout_index, iout_level in enumerate(self.iout_list_A):
                ...
                if self.measure_ripple:
                    ...
                    waveform_filename = f"{self.vin_freq[0]:g}V{self.coupling}_{self.vout_V:g}V_{iout_A:g}A_CDC_{self.cdc_mV:g}mV_{self.dcm_text}_{self.sr_zvs_text}.png"
    ...
    def extract_test_condition(test_item_dict:dict)->dict:
        test_object_class = I2C_LoadRegTest
