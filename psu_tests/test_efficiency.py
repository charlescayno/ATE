...
class EfficiencyTest(BaseTestObject):
    """
        ...
        for self.vin_index, self.vin_freq in enumerate(self.vin_list): 
            ...
            for iout_index, iout_level in enumerate(self.iout_list_A):                 
                ...
                # For 10% efficiency
                    ...
                    eff_temp_10 = (self.test_data.pout_W / self.test_data.pin_W * 100) if (self.test_data.pin_W and self.test_data.pin_W > 0) else 0
                    if self.vout_V < standard_low_voltage_V:
