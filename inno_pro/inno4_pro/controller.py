...
class Inno4ProI2CController(CP2112):
    """ Class for the SMBUS interface to directly send I2C commands to DUT.
        Used specifically for InnoSwitch4-Pro family devices
    """
    ...
    def __init__(self, rsense_mohm=6, *args, **kwargs):
        ...
        self.registers = Inno4Pro_I2C_Registers()
        self.commands = Inno4Pro_I2C_Commands()
        self.defaults = Inno4Pro_I2C_Defaults()
        self.params = Inno4Pro_Parameters()
        self.readback_commands = Inno4Pro_I2C_Readback_Registers()
        self.readback_commands_list = INNO4_PRO_READBACK_REG_LIST
        self.registers_list = INNO4_PRO_REG_LIST
    ...
    def bleeder(self, bleeder_en, 
                weak_bleeder_en=Inno4Pro_I2C_Commands.WEAK_BLEEDER_OFF):
    ...
    def uva(self, 
        ...
        reg:UVA = process_uva_command(threshold_V= threshold_V, response = response, timer = timer)
    ...
    def send_read_command(self, register):
        ...
        if register in INNO4_PRO_READBACK_REG_LIST:
