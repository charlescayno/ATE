...
class ACSource(Equipment):
    ...
    def turn_on(self):
        ...
        print(f'[AC_SOURCE] AC Source {self.device_id}: Output ON')
        self.write(f'{self.command_output} ON')

    def turn_off(self):
        print(f'[AC_SOURCE] AC Source {self.device_id}: Output OFF')
    ...
    def set_voltage_with_coupling(self,voltage,coupling):
        print(f'[AC_SOURCE] AC Source {self.device_id}: Set Voltage to {voltage}V (Coupling: {coupling})')
