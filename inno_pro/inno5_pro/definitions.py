import ctypes as ct
from ctypes import c_uint16, c_uint16

class Inno5Pro_Parameters():
    CV_MAX_V = 30
    CV_MIN_V = 3
    CV_RESOLUTION_MV = 10
    ...
    SR_ZVS_DELAY_MAX_COUNT = 31
    SR_ZVS_ON_TIME_MAX_COUNT = 31
    
    SR_ZVS_DELAY_MIN_COUNT = 2
    SR_ZVS_ON_TIME_MIN_COUNT = 0
    ...
    SR_UNWANTED_PULSE_MIN_COUNT = 0
    SR_UNWANTED_PULSE_MAX_COUNT = 7

    TIMING_RESOLUTION_NS = 85
    

class Inno5Pro_I2C_Defaults():
    INNOPRO_SLAVE_ADDR  =   0x18      # InnoSwitch5-Pro I2C 7-bit Slave Address
...
class Inno5Pro_I2C_Registers():
    ...
    SR_ZVS_REG =          	0x3E		# Synch Rectifier based Zero Voltage Switching
    CDC_REG =               0x16        # Cable Drop Compensation Register
    LINE_SENSE_REG =        0x1C        # Input Line Sense Register
    READ_CMD_REG =          0x80        # Readback command Register
    
    # Special Registers
    LOOP_OPTION_REG =       0x7C        # Loop option register (different from loop speed 1 & 2)
    SR_DISABLE_REG =        0x38
    CV_LOAD_SREG =          0xFE        # Special Register for CV Load settings
    
class Inno5Pro_I2C_Readback_Registers():
    ...
    READ5 =         0x0A		#  Constant Power Set-Point
    READ6 =         0x0C		#  OVL,UVL,CCSC,ISSC,UVLTIMER,WDTIMER,CVOL,CVTIMER	
    READ7 =         0x0E		#  FWDPK, VBEN, BLEEDER, DISCHARGE, FAST VI, CVO MODE, OTP FAULT, CDC
    READ8 =         0x10        #  Instantaneous Measured current
    READ9 =         0x12		#  Instantaneous Measured Voltage  
    READ10 =        0x14		#  INNTERRUPT, CONTROL_S, VDIS_REG, LS_READY, LOW_FSW, WRITE_AUTO_CV, OTP, VOUT2PCT, VOUT10PCT, ISSC, CCSC, VOUT_UV, VOUT_OV 
    READ11 =        0x16	    #  FWD_PK_DAC, MODE (OMF)
    ...
    READ15 =        0x1E	    #  CVO_DO, ISSC_DO, CCSC_DO, VOUT_OV_DO, VOUT_UV_DO, WDTIMER 
    READ16 =        0x20	    #  CVO_AR, VBUSSC_AR, ISSC_AR, CCSC_AR, VOUT_OV_AR, VOUT_UV_AT, PSU_OFF, CVOL_LO, VBUDDC_LO, ISSC_LO, CCSC_LO, VOUT_OV_LO, VOUT_UV_LO, BPS_OV_LO
    ...
    READ21 =        0x2A	    #  TON_COUNT 
    READ22 =        0x2C	    #  TOFF_COUNT 
    READ23 =        0x2E	    #  SIGN, OFFSET
    READ24 =        0x30	    #  COUNT, FREQUENCY
    ...
    READ_LINE_SENSE_TON =   READ21     # Line Sense readback for Ton
    READ_LINE_SENSE_TOFF =  READ22     # Line Sense readback for Toff
    READ_LS_READY =         READ10     # LS RDY
...
INNO5_PRO_SINGLE_BYTE_COMMAND_LIST = [
    Inno5Pro_I2C_Registers.FWD_PEAK_REG,
    Inno5Pro_I2C_Registers.WATCHDOG_REG, 
    Inno5Pro_I2C_Registers.VBEN_REG,
    Inno5Pro_I2C_Registers.BLEEDER_REG,
    Inno5Pro_I2C_Registers.VDIS_REG,
    Inno5Pro_I2C_Registers.TURN_OFF_PSU_REG,
    Inno5Pro_I2C_Registers.FAST_VI_REG,
    Inno5Pro_I2C_Registers.CVO_REG,
    Inno5Pro_I2C_Registers.CCSC_REG, 
    Inno5Pro_I2C_Registers.ISSC_REG,
    Inno5Pro_I2C_Registers.VBUSSC_REG,
    Inno5Pro_I2C_Registers.OTP_REG,
    Inno5Pro_I2C_Registers.DCM_ONLY_REG,
    Inno5Pro_I2C_Registers.CDC_REG,
    Inno5Pro_I2C_Registers.LINE_SENSE_REG,
]
...
INNO5_PRO_REG_LIST =[
    ...
    Inno5Pro_I2C_Registers.WATCHDOG_REG, 
    Inno5Pro_I2C_Registers.VBEN_REG,
    Inno5Pro_I2C_Registers.CV_REG,
    Inno5Pro_I2C_Registers.BLEEDER_REG,
    Inno5Pro_I2C_Registers.VDIS_REG,
    Inno5Pro_I2C_Registers.TURN_OFF_PSU_REG,
    Inno5Pro_I2C_Registers.FAST_VI_REG,
    Inno5Pro_I2C_Registers.CVO_REG,
    Inno5Pro_I2C_Registers.OVA_REG, 
    Inno5Pro_I2C_Registers.UVA_REG,
    Inno5Pro_I2C_Registers.CC_REG, 
    Inno5Pro_I2C_Registers.VKP_REG,
    Inno5Pro_I2C_Registers.CCSC_REG, 
    Inno5Pro_I2C_Registers.ISSC_REG,
    Inno5Pro_I2C_Registers.VBUSSC_REG,
    Inno5Pro_I2C_Registers.INT_MASK_REG,
    Inno5Pro_I2C_Registers.OTP_REG,
    Inno5Pro_I2C_Registers.FAST_CC_REG,
    Inno5Pro_I2C_Registers.LOOPSPEED_1_REG,
    Inno5Pro_I2C_Registers.LOOPSPEED_2_REG,
    Inno5Pro_I2C_Registers.DCM_ONLY_REG,
    Inno5Pro_I2C_Registers.SR_ZVS_REG,
    Inno5Pro_I2C_Registers.CDC_REG,
    Inno5Pro_I2C_Registers.LINE_SENSE_REG,
    Inno5Pro_I2C_Registers.READ_CMD_REG,
    Inno5Pro_I2C_Registers.LOOP_OPTION_REG,
    Inno5Pro_I2C_Registers.SR_DISABLE_REG, 
    ]  
    
INNO5_PRO_READBACK_REG_LIST =[
    Inno5Pro_I2C_Readback_Registers.READ0,
    Inno5Pro_I2C_Readback_Registers.READ1,
    Inno5Pro_I2C_Readback_Registers.READ2,
    Inno5Pro_I2C_Readback_Registers.READ3,
    Inno5Pro_I2C_Readback_Registers.READ4,
    Inno5Pro_I2C_Readback_Registers.READ5,
    Inno5Pro_I2C_Readback_Registers.READ6,
    Inno5Pro_I2C_Readback_Registers.READ7,
    Inno5Pro_I2C_Readback_Registers.READ8,
    Inno5Pro_I2C_Readback_Registers.READ9,
    Inno5Pro_I2C_Readback_Registers.READ10,
    Inno5Pro_I2C_Readback_Registers.READ11,
    Inno5Pro_I2C_Readback_Registers.READ12,
    Inno5Pro_I2C_Readback_Registers.READ13,
    Inno5Pro_I2C_Readback_Registers.READ14,
    Inno5Pro_I2C_Readback_Registers.READ15,
    Inno5Pro_I2C_Readback_Registers.READ16,
    Inno5Pro_I2C_Readback_Registers.READ17,
    Inno5Pro_I2C_Readback_Registers.READ18,
    Inno5Pro_I2C_Readback_Registers.READ19,
    Inno5Pro_I2C_Readback_Registers.READ20,
    Inno5Pro_I2C_Readback_Registers.READ21,
    Inno5Pro_I2C_Readback_Registers.READ22,
    Inno5Pro_I2C_Readback_Registers.READ23,
    Inno5Pro_I2C_Readback_Registers.READ24,
]


class Inno5Pro_I2C_Commands():
    # FWD_PEAK
    ...
    FWD_PEAK_PRESHIFT_150NS = 0b11       # Set FW Peak Pre-shift to 150 ns (bit 3:4)
    FWD_PEAK_PRESHIFT_120NS = 0b10       # Set FW Peak Pre-shift to 120 ns (bit 3:4)
    FWD_PEAK_PRESHIFT_90NS = 0b01       # Set FW Peak Pre-shift to 90 ns (bit 3:4)
    FWD_PEAK_PRESHIFT_60NS = 0b00       # Set FW Peak Pre-shift to 60 ns (bit 3:4)
    ...
    WEAK_BLEEDER_ON =       0b1         # Weak Bleeder Enabled (bit 4:7)
    WEAK_BLEEDER_OFF =      0b0         # Weak Bleeder Enabled (bit 4:7)  
    
    WEAK_BLEEDER_VOUT4PCT = 0b110       # Weak Bleeder Threshold set to 4% (Default)
    WEAK_BLEEDER_VOUT2PCT = 0b101       # Weak Bleeder Threshold set to 2% (Needs verification)
    ...
    VDIS_OFF =              0b1110		# Disable Discharge (bit 0:3)
    ...
    # OVA
    OVA_RESP_DO =           0b11		# Overvoltage Fault Response Set to Disable Output (bit 10:11)
    OVA_RESP_AR =           0b10		# Overvoltage Fault Response Set to Auto-Restart (bit 10:11)
    OVA_RESP_LO	=           0b01        # Overvoltage to Latch Off (bit 10:11)
    OVA_RESP_NR	=           0b00        # Overvoltage to NO Response (bit 10:11)
    
    OVA_PARITY =            True        # Parity Needed for OVA
    
    # UVA
    UVA_RESP_DO =           0b11		# Undervoltage Fault Response Set to Disable Output (bit 10:11)
    UVA_RESP_AR =           0b10		# Undervoltage Fault Response Set to Auto-Restart (bit 10:11)
    UVA_RESP_LO	=           0b01        # Under-Voltage to Latch Off (bit 10:11)
    UVA_RESP_NR	=           0b00        # Under-Voltage to NO Response (bit 10:11)
    
    UVA_TIMER_64MS =        0b11	    # Undervoltage Fault Timer Set to 64ms (bit 12:13)
    UVA_TIMER_32MS =        0b10		# Undervoltage Fault Timer Set to 32ms (bit 12:13)
    UVA_TIMER_16MS =        0b01		# Undervoltage Fault Timer Set to 16ms (bit 12:13)
    UVA_TIMER_8MS =         0b00		# Undervoltage Fault Timer Set to 8ms (bit 12:13)
    
    UVA_ENABLE_TIMER =      0b0         # Enable Timer for UVA (bit 14)
    UVA_DISABLE_TIMER =     0b1         # Disable Timer for UVA (bit 14)    
    ...
    # SR ZVS
    SR_ON_TIME_85NS_D2 =     0b00010		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D3 =     0b00011		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D4 =     0b00100		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D5 =     0b00101    	# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D6 =     0b00110		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D7 =     0b00111		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D8 =     0b01000		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D9 =     0b01001	    # SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D10 =    0b01010		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D11 =    0b01011		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D12 =    0b01100		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D13 =    0b01101	    # SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D14 =    0b01110		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D15 =    0b01111		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D16 =    0b10000		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D17 =    0b10001		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D18 =    0b10010		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D19 =    0b10011		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D20 =    0b10100		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D21 =    0b10101		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D22 =    0b10110		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D23 =    0b10111		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D24 =    0b11000		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D25 =    0b11001		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D26 =    0b11010		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D27 =    0b11011		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D28 =    0b11100		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D29 =    0b11101		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D30 =    0b11110		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    SR_ON_TIME_85NS_D31 =    0b11111		# SR On Time 85ns steps from d2 to d31 (bit 0:4)
    
    SR_ZVS_DELAY_85NS_D2 =   0b00010		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D3 =   0b00011		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D4 =   0b00100		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D5 =   0b00101    	# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D6 =   0b00110		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D7 =   0b00111		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D8 =   0b01000		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D9 =   0b01001	    # SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D10 =  0b01010		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D11 =  0b01011		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D12 =  0b01100		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D13 =  0b01101	    # SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D14 =  0b01110		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D15 =  0b01111		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D16 =  0b10000		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D17 =  0b10001		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D18 =  0b10010		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D19 =  0b10011		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D20 =  0b10100		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D21 =  0b10101		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D22 =  0b10110		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D23 =  0b10111		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D24 =  0b11000		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D25 =  0b11001		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D26 =  0b11010		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D27 =  0b11011		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D28 =  0b11100		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D29 =  0b11101		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D30 =  0b11110		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    SR_ZVS_DELAY_85NS_D31 =  0b11111		# SR Delay Time 85ns steps from d2 to d31 (bit 5:9)
    
    SR_ZVS_ENABLED =         0b1		    # SR ZVS Enabled (bit 10)
    SR_ZVS_DISABLED	=        0b0		    # SR ZVS Disabled (bit 10)
    
    SR_ZVS_VALLEY_SW_ON	=    0b1		    # FWD Valley Switching Enabled (bit 11)
    SR_ZVS_VALLEY_SW_OFF =   0b0		    # FWD Valley Switching Disabled (bit 11)
    
    SR_ZVS_PARITY =          False          # Parity not needed for SR ZVS

    # LINE_SENSE
    LINE_SENSE_ENABLED =     0b1            # Line Sense Enabled (bit 0)
    LINE_SENSE_DISABLED =    0b0            # Line Sense Enabled (bit 0)
    LINE_SENSE_PARITY =      False          # Parity not needed for LINE_SENSE
    ...
    LOOP_OPTION_CV_LOAD_LSB =       0x94           # LSB of Loop Option 2
    LOOP_OPTION_CV_LOAD_MSB =       0x87           # MSB of Loop Option 2
    
    # SR DISABLE
    SR_ON_PROTECTON_ENABLED =               0b1     # Protection for SR ON Enabled (bit 11)
    SR_ON_PROTECTON_DISABLED =              0b0     # Protection for SR ON Disabled (bit 11)
    
    SR_ZVS_ON_PROTECTON_ENABLED =           0b1     # Protection for SR ZVS ON Enabled (bit 10)
    SR_ZVS_ON_PROTECTON_DISABLED =          0b0     # Protection for SR ZVS ON Disabled (bit 10)
    
    SR_PROTECTION_THRESHOLD_300MV =         0b00    # 300 mV Protetcion Threshold for SR Disable (bit 8:9)
    SR_PROTECTION_THRESHOLD_100MV =         0b01    # 100 mV Protetcion Threshold for SR Disable (bit 8:9)
    SR_PROTECTION_THRESHOLD_200MV =         0b10    # 200 mV Protetcion Threshold for SR Disable (bit 8:9)
    SR_PROTECTION_THRESHOLD_400MV =         0b11    # 400 mV Protetcion Threshold for SR Disable (bit 8:9)
    
    SR_DISABLE_BIT5_ENABLE =                0b1     # Enable bit 5 for SR Disable Register (bit 5)
    SR_DISABLE_BIT5_DISABLE =               0b0     # Enable bit 5 for SR Disable Register (bit 5)

    SR_DISABLE_BIT4_ENABLE =                0b1     # Enable bit 4 for SR Disable Register (bit 4)
    SR_DISABLE_BIT4_DISABLE =               0b0     # Enable bit 4 for SR Disable Register (bit 4)
    
    SR_UNWANTED_PULSE_PROTECTION_ENABLED =  0b1     # Enable Protection for SR unwanted pulse (bit 3)
    SR_UNWANTED_PULSE_PROTECTION_DISABLED = 0b0     # Disable Protection for SR unwanted pulse (bit 3)
    
    SR_UNWANTED_PULSE_COUNT_0 =             0b000   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_1 =             0b001   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_2 =             0b010   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_3 =             0b011   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_4 =             0b100   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_5 =             0b101   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_6 =             0b110   # SR unwanted pusle count before protection (bit 0:2)
    SR_UNWANTED_PULSE_COUNT_7 =             0b111   # SR unwanted pusle count before protection (bit 0:2)
    
    SR_DISABLE_PARITY =          False      # Parity not needed for SR Disable
    
    # Special register 0xFE for CV load
    SREG_CV_LOAD_RECOMMENDED_LSB =                      0x00
    SREG_CV_LOAD_RECOMMENDED_MSB =                      0x92
    
    SREG_CV_LOAD_BPS_OV_DISABLED_LSB =                      0x00
    SREG_CV_LOAD_BPS_OV_DISABLED_MSB =                      0xB2
         

# COMMAND REGISTERS FOR INNO5-PRO

class CV_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("vout_low_byte",               c_uint16, 7),  
        ("lowbyte_parity",              c_uint16, 1),
        ("vout_high_byte",              c_uint16, 5),
        ("auto_cv",                     c_uint16, 1),   
        ("reserved",                    c_uint16, 1),  
        ("highbyte_parity",             c_uint16, 1)]   
class CV(ct.Union):
...
class CC_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("iout_low_byte",               c_uint16, 7),  
        ("lowbyte_parity",              c_uint16, 1),
        ("iout_high_byte",              c_uint16, 1),
        ("reserved",                    c_uint16, 6), 
        ("highbyte_parity",             c_uint16, 1)]   
...
class VKP_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("vkp_low_byte",                c_uint16, 7),  
        ("lowbyte_parity",              c_uint16, 1),
        ("vkp_high_byte",               c_uint16, 7),
        ("highbyte_parity",             c_uint16, 1)]   
...
class OVA_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("thresh_low_byte",             c_uint16, 7),
        ("lowbyte_parity",              c_uint16, 1),
        ("thresh_high_byte",            c_uint16, 2),
        ("response",                    c_uint16, 2),
        ("reserved",                    c_uint16, 3),   
        ("highbyte_parity",             c_uint16, 1)]  
class OVA(ct.Union):
...
class BLEEDER_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("bleeder_enable",              c_uint16, 2),
		("bleeder_thresh",				c_uint16, 1),
        ("reserved2",                   c_uint16, 1),
        ("weak_bleeder_enable",         c_uint16, 1),
        ("weak_bleeder_thresh",         c_uint16, 3),
        ("reserved",                    c_uint16, 8)]
...
class INT_MASK_bits(ct.LittleEndianStructure):
    _fields_ = [
        ...
        ("issc",                        c_uint16, 1),
        ("cvol",                        c_uint16, 1),
        ("latch_off",                   c_uint16, 1),
        ("control_s",                   c_uint16, 1),
        ("vbussc",                      c_uint16, 1),
        ("omf",                         c_uint16, 1),
        ("reserved",                    c_uint16, 7)]
...
class FAST_CC_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("fast_cc_offset",              c_uint16, 5),
        ("fast_cc_enable",              c_uint16, 1),
        ("calibration_disable",         c_uint16, 1),
        ("reserved0",                   c_uint16, 1),
        ("slow_cc_offset",              c_uint16, 5),
...
class LOOPSPEED_1_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("cv_small_step_thresh",        c_uint16, 8),
        ("cv_large_step_thresh",        c_uint16, 8)]
...
class LOOPSPEED_2_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("cc_small_step_thresh",        c_uint16, 4),
        ("cc_large_step_thresh",        c_uint16, 4),
        ("large_step_size",             c_uint16, 4),
        ("small_step_size",             c_uint16, 4)]
...
class SR_ZVS_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("on_time",                      c_uint16, 5),
        ("delay",                        c_uint16, 5),
        ("sr_zvs_enable",                c_uint16, 1),
        ("fwd_valley_switch_enable",     c_uint16, 1),
        ("reserved",                     c_uint16, 4)]
class SR_ZVS(ct.Union):
    _fields_ = [("bits", SR_ZVS_bits),
                ("asbyte", c_uint16)]
    
class LINE_SENSE_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("line_sense_enable",            c_uint16, 1),
        ("reserved",                     c_uint16, 7)]
class LINE_SENSE(ct.Union):
    _fields_ = [("bits", LINE_SENSE_bits),
                ("asbyte", c_uint16)]

class READBACK_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("high_readback_register",      c_uint16, 7),
        ("lowbyte_parity",              c_uint16, 1),
        ("low_readback_register",       c_uint16, 7),
        ("highbyte_parity",             c_uint16, 1)]
class READBACK(ct.Union):
    _fields_ = [("bits", READBACK_bits),
                ("asbyte", c_uint16)]
    
# SPECIAL WRITE REGISTERS FOR INNO5_PRO

class SR_DISABLE_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("unwanted_pulse_count",        c_uint16, 3),
        ("unwanted_pulse_protection",   c_uint16, 1),
        ("bit_4",                       c_uint16, 1),
        ("bit_5",                       c_uint16, 1),
        ("reserved0",                   c_uint16, 2),
        ("threshold_mV",                c_uint16, 2),
        ("sr_zvs_on_protection",        c_uint16, 1),
        ("sr_on_protection",            c_uint16, 1),
        ("reserved1",                   c_uint16, 4)]
    
class SR_DISABLE(ct.Union):
    _fields_ = [("bits", SR_DISABLE_bits),
                ("asbyte", c_uint16)]

# READBACK REGISTERS FOR INNO5_PRO
...
class READ6_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("cvo_timer",               c_uint16, 2),
        ("cvo_response",            c_uint16, 2),
        ("wd_timer",                c_uint16, 2),
        ("uva_timer",               c_uint16, 2),
        ("issc_response",           c_uint16, 2),
        ("ccsc_response",           c_uint16, 2),
        ("uva_response",            c_uint16, 2),
        ("ova_response",            c_uint16, 2)]
...
class READ7_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("cdc",                     c_uint16, 4),
        ("reserved0",               c_uint16, 5),
        ("otp_hysteresis",          c_uint16, 1),
        ("cvo",                     c_uint16, 1),
        ("fstvic",                  c_uint16, 1),
        ("psu_off",                 c_uint16, 1),
        ("bleeder",                 c_uint16, 1),
...
class READ9_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("output_voltage",          c_uint16, 12),
        ("reserved0",               c_uint16, 4)]
...
class READ10_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("reg_vout_ov",             c_uint16, 1),   # Output OV Fault Comparator
        ("reg_vout_uv",             c_uint16, 1),   # Output UV Fault comparator
        ("reg_ccsc",                c_uint16, 1),   # Output short-circuit detected
        ("reg_issc",                c_uint16, 1),   # IS-pin short circuit detected
        ("reg_vout10pct",           c_uint16, 1),   # VOUTADC > 1.1*Vout
        ("reg_voutwk",              c_uint16, 1),   # Weak bleeder enabled?
        ("sc_chy_b",                c_uint16, 1),
        ("sr_short",                c_uint16, 1),
        ("sr_open",                 c_uint16, 1),   
        ("reg_otp",                 c_uint16, 1),   # OTP Fault?    
        ("reg_cv_en",               c_uint16, 1),   # AutoCV Enabled?
        ("reg_low_fsw",             c_uint16, 1),   # Switching Frequency Low?
        ("reg_line_sense",          c_uint16, 1),   # Switching Frequency High?
        ("reg_vdis",                c_uint16, 1),   # Output Discharge
        ("reg_control_s",           c_uint16, 1),   # System Ready Signal
        ("reg_interrupt_en",        c_uint16, 1)]  # Interrupt Enable
...
class READ15_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("reg_watchdog",             c_uint16, 1),
        ("reg_do_vout_uv",           c_uint16, 1),
        ("reg_do_vout_ov",           c_uint16, 1),
        ("reg_do_ccsc",              c_uint16, 1),
        ("reg_do_issc",              c_uint16, 1),
        ("reg_do_cvo",               c_uint16, 1),
        ("reserved0",               c_uint16, 10)]   
class READ15(ct.Union):
    """Disable output faults and Watchdog triggered"""
    _fields_ = [("bits", READ15_bits),
                ("asbyte", c_uint16)]
    def __init__(self, u16=0):
        self.asbyte=u16
...
class READ16_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("reg_lo_bps_ov",           c_uint16, 1),
        ("reg_lo_vout_uv",          c_uint16, 1),
        ("reg_lo_vout_ov",          c_uint16, 1),
        ("reg_lo_ccsc",             c_uint16, 1),
        ("reg_lo_issc",             c_uint16, 1),
        ("reg_lo_vbussc",           c_uint16, 1),
        ("reg_lo_cvo",              c_uint16, 1),
        ("reg_psuoff",              c_uint16, 1),
        ("reserved1",               c_uint16, 1),
        ("reg_ar_vout_uv",          c_uint16, 1),
        ("reg_ar_vout_ov",          c_uint16, 1),
        ("reg_ar_ccsc",             c_uint16, 1),
        ("reg_ar_issc",             c_uint16, 1),
        ("reg_ar_vbussc",           c_uint16, 1),
        ("reg_ar_cvo",              c_uint16, 1),
        ("reserved0",               c_uint16, 1)]
...
class READ17_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("ov_int_status",           c_uint16, 1),
        ("uv_int_status",           c_uint16, 1),
        ("ccsc_int_status",         c_uint16, 1),
        ("issc_int_status",         c_uint16, 1),
        ("cvo_ar_int_status",       c_uint16, 1),
        ("lo_fault_int_status",     c_uint16, 1),
        ("control_s_int_status",    c_uint16, 1),
        ("vbussc_int_status",       c_uint16, 1),
        ("omf_int_status",          c_uint16, 1),
        ("ov_int_mask",             c_uint16, 1),
        ("uv_int_mask",             c_uint16, 1),
        ("ccsc_int_mask",           c_uint16, 1),
        ("issc_int_mask",           c_uint16, 1),
        ("cvo_ar_int_mask",         c_uint16, 1),
        ("lo_fault_int_mask",       c_uint16, 1),
        ("control_s_int_mask",      c_uint16, 1)]
...
# READ21 - 0x2A - Line Sense TON Report
class READ21_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("ton_report",              c_uint16, 12),
        ("reserved",                c_uint16, 4)]   
class READ21(ct.Union):
    """Line Sense TON Report
    16 sample accumulated value of primary switch ON time
    """
    _fields_ = [("bits", READ21_bits),
                ("asbyte", c_uint16)]
    def __init__(self, u16=0):
        self.asbyte=u16

# READ22 - 0x2C - Line Sense TOFF Report
class READ22_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("toff_report",             c_uint16, 16)]   
class READ22(ct.Union):
    """Line Sense TOFF Report
    16 sample accumulated value of primary SR ON time
    """
    _fields_ = [("bits", READ22_bits),
                ("asbyte", c_uint16)]
    def __init__(self, u16=0):
        self.asbyte=u16
    
# READ23 - 0x2E - End of Line Calibration
class READ23_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("cc_offset",               c_uint16, 3),   
        ("offset_sign",             c_uint16, 1),
        ("reserved",                c_uint16, 12)]
class READ23(ct.Union):
    """End of line calibration
    """
    _fields_ = [("bits", READ23_bits),
                ("asbyte", c_uint16)]
    def __init__(self, u16=0):
        self.asbyte=u16
        
# READ24 - 0x30 - Frequency Counter
class READ24_bits(ct.LittleEndianStructure):
    _fields_ = [
        ("freq_count",               c_uint16,16)]
class READ24(ct.Union):
    """Frequency Counter
    """
    _fields_ = [("bits", READ24_bits),
                ("asbyte", c_uint16)]
    def __init__(self, u16=0):
        self.asbyte=u16
