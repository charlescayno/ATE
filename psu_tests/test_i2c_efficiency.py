...
class I2C_EfficiencyTest(BaseTestObject):
    ...
    i2c_ui_definitions.add_lineedit(label='CDC (mV)', param_index=3)
    ...
    # i2c_ui_definitions.add_cbx(label="Loop Option", contents=['Default', 'Option 1', 'Option 2'], param_index=3)
    ...
    def set_i2c_ui_definitions(self):
        ...
        self.i2c_ui_definitions.add_lineedit(label='CDC (mV)', param_index=3)
    ...
    def i2c_initialize(self):
        ...
        self.i2c_controller.cdc(self.cdc_mV)  
    ...
    def update_test_list_text(self):
        ...
        text += f"CDC: {self.cdc_mV:g} mV, Family: {self.innopro_family}, "
        match self.innopro_family:
            case InnoProFamily.Inno5Pro:
    ...
    def setup_data_file(self):
        ...
        self.sheet_name = f"{self.short_title}_{self.coupling}_{self.vout_V:g}V_{self.i_max_A:g}A_{self.cdc_mV:g}mV"
    ...
    def prepare_test_conditions(self):
        ...
        self.vout_V = (math.floor(int(self.vout_V*1000)
                        / self.i2c_params.CV_RESOLUTION_MV)
                        * self.i2c_params.CV_RESOLUTION_MV/1000)
        
        self.cdc_mV  = (math.floor(self.cdc_mV/self.i2c_params.CDC_RESOLUTION_MV)
                        * self.i2c_params.CDC_RESOLUTION_MV)
    ...
    def define_data_header(self):
        ...
        header_list = [
            'Load',f'V{self.coupling.upper()} (rms)','Freq (Hz)','Vin (rms)','Iin (mA)',
    ...
    def extract_test_condition(test_item_dict:dict)->dict:
        test_object_class = I2C_EfficiencyTest
